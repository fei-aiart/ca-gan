...
- A face photo&+rarr;sketch  model  and a face sketch&+rarr;photo  model pre-trained on the CUFS uses new parsing network(Bisenet)[[BaiDu Cloud]](https://pan.baidu.com/s/1n-PcEoOq9Jb5UvpvTUExTA)(pwd:tqek)
